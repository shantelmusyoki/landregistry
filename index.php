                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            style="background-image: url('images/bg-image/bg-1.jpg'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat;">  
                                ...
                                <p>With the permission of the owners we are able to advertise and rent lands for different purposes.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                            style="background-image: url('images/bg-image/bg-1.jpg'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat;">   
                                ...
                                <p>We advertise and sell lands that are available in machakos county. Our main aim is to offer 
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            style="background-image: url('images/bg-image/bg-1.jpg'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat;">  
                                ...
                                <p>our Goal is to give our customers the best and thats why we go out of our way 
                            ...
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                             style="background-image: url('images/bg-image/bg-1.jpg'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat;"> 
                                ...
                                <p>We offer a platform for land investment. The idea behind this is that we are able to list lands that have the
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										// $query=mysqli_query($con,"SELECT count(state), property.* FROM property where state='machakos'");

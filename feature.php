                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="sellerindex.php">Home</a></li>
					...
					<table class="items-list col-lg-12" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-primary">
                                ...
                                <th class="text-white font-weight-bolder">selling type</th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-primary font-13"></i>&nbsp; <?php echo $row['7'];?></span>
                                        <div class="price mt-3">
											<span class="text-primary">KSHS&nbsp;<?php echo $row['6'];?>M</span>
										</div>
                                    </div>
								</td>

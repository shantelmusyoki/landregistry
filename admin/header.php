  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" >
						<img src="assets/img/ilogo2.png" alt="Logo">
					</a>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userbuyer.php"> Buyers </a></li>
									<li><a href="userseller.php"> Sellers </a></li>
									<li><a href="userexpert.php"> Experts </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> lands</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="propertyadd.php"> Add land</a></li>
									<li><a href="propertyview.php"> View land </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span>County & Area</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php"> County </a></li>
									<li><a href="cityadd.php"> Area </a></li>
								</ul>
							</li>

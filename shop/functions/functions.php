...
$check_product = "select * from cart where ip_add='$ip_add' AND pid='$pid'";
...
$query = "insert into cart (pid,ip_add,qty,size) values ('$pid','$ip_add','$qty','$size')";

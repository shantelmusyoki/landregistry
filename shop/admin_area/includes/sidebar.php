...
<i class="fa fa-fw fa-power-off"></i>Log Out    
 ...
 <i class="fa fa-fw fa-arrows-v"></i>Category  
 <i class="fa fa-fw fa-caret-down"></i>
  </a>
 ...
 <li>
    ...
    <i class="fa fa-fw fa-pencil"></i>View Delivery    
  ...
  <ul id="users" class="collapse">
    ...
    <li>
      <a href="index.php?user_profile=<?php echo $admin_id; ?>">Edit Profile</a> 
           ...
           <li>
  <a href="#" data-toggle="collapse" data-target="#messages">
 <i class="fa fa-fw fa-envelope"></i> Customer Contact  
 <i class="fa fa-fw fa-caret-down"></i>
  </a>
  ...
  <ul id="messages" class="collapse">
    ...
    <li>
    <a href="index.php?view_slides">Messages</a>    
    </li>
     
       <li>
    <a href="index.php?edit_slide">Join Requests</a> 

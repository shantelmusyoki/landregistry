...
if(isset($_REQUEST['login']))
{
	...
	{
		$sql = "SELECT * FROM user where uemail='$email' AND utype= 'Sellers'";
		...
		$row=mysqli_fetch_array($result);
		   if($row){
				...
				header("location:sellerabout.php");
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<div class="text-center dont-have">Don't have an account? <a href="registerseller.php">Register</a></div>

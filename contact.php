                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Kathozweni Street, Eastleigh 07, Machakos</span> 
										<span class="text-secondary">Katoloni Street, KenyaIsrael 07, Machakos</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">+254 757 689 061</span>
										<span class="text-secondary">+254 720 042 959 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">support@insta.com</span>
										<span class="text-secondary">support@insta.com</span>
										</div>
                                </li>
                            </ul>
                        </div>

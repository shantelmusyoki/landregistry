...
<div id="page-wrapper">
    <div class="row"> 
        <!--	Header start  -->
		<?php include("include/headersellerindex.php");?>
        <!--	Header end  -->
		
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('admin/property/slider/land3.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-primary">Land</span><br>
                                for sale</h1>
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" placeholder="Enter any area in Machakos county" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-primary w-100">Search Land</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                            style="background-image: url('images/bg-image/pattern/13.png'); background-size: cover; background-position: center;
                              background-repeat: no-repeat; opacity:0.9;"> 
                                ...
                                <p style="color:white; font-weight: 1100;">With the permission of the owners we are able to advertise and rent lands for different purposes.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                            style="background-image: url('images/bg-image/pattern/13.png'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat; opacity:0.9;"> 
                                ...
                                <p style="color:white; font-weight: 1100;">We advertise and sell lands that are available in machakos county. Our main aim is to offer 
                                 you a land having all facts and information at hand </p>
                            </div>
                        </div>
                        ...
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                            style="background-image: url('images/bg-image/pattern/13.png'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat; opacity:0.9;"> 
                                ...
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Land Listing</a></h5>
                                <p style="color:white; font-weight: 1100;">our Goal is to give our customers the best and thats why we go out of our way 
                                    to provide our customers with detailed information about our lands. This makes it easier for them to 
                                    get ll they want in one platform.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"
                            style="background-image: url('images/bg-image/pattern/13.png'); background-size: cover; background-position: center center;
                              background-repeat: no-repeat; opacity:0.9;"> 
                                ...
                                <h5 class="text-secondary hover-text-primary py-3 m-0"><a href="#">Legal Land Investment</a></h5>
                                <p style="color:white; font-weight: 1100;">We offer a platform for land investment. The idea behind this is that we are able to list lands that have the
                                    potental of increasing their value in the next five years. we also advise on land issues with the help of land experts
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recent Land</h2>
                    </div>
                    <!--- <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['12'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>KSHS <?php echo $row['6'];?>million</b><span class="text-white">
                                                    <?php echo $row['5'];?> hectares</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    ...
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-primary"></i> <?php echo $row['7'];?></span> </div>
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['3'];?></span> Purpose Of The Land</li>
                                                        
                                                    </ul>
                                                </div>
                                                <div class="p-4 d-inline-block w-100">
                                                    <div class="float-left text-capitalize"><i class="fas fa-user text-primary mr-1"></i>By : <?php echo $row['uname'];?></div>
                                                    <div class="float-right"><i class="far fa-calendar-alt text-primary mr-1"></i> 3 Months Ago</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>we are a team whose main goal is to give our customers quality services in all they require.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Vision and Core Values</h5>
										<p>Our vision is to eradicate land fraudary. Our core values is to provide Genuine lands with affordable prices.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Top-notch Prices In The Market</h5>
										<p> We negotiate the best land deals in the market</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>once you identify the land that you are interested in from our website application,
                                the other step you are required to undertake is a discussion with the buyer.Incase of any inquiries then you can consult our experts
                                for advice in any land matter.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>This includes going through all legal procedures required to finally own the land. We have partnered with land surveyors
                                and other land experts to ensure that the files review process is legal. </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>This is last stage where the buyer will officially own their land. Our advocates will prepare transfer of documents,
                                 that will be executed by us and the buyer. The transfer documents will only be executed after consent to transfer has been issued by the commissioner 
                                 of lands (who are also in partnership with).
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-primary my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5"> Available Lands</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-primary my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?> 
                                <div class="text-white h5">Available Lands For Sale</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-primary my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Available Lands For Rent</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='katoloni'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['8']?>">katoloni</a></h4>
                                    <span><?php 
												$total = $row[0];
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='kathemboni'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['8']?>">kathemboni</a></h4>
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Properties Listed</span> </div>
									<?php } ?>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Eastleigh'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['8']?>">Eastleigh</a></h4>
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Properties Listed</span> </div>
									<?php } ?>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Kenya israel'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['8']?>">kenya israel</a></h4>
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Properties Listed</span> </div>
									<?php } ?>

                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['12'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">KSH<?php echo $row['6'];?>million<span class="text-white">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <div class="bg-primary d-table px-3 py-2 rounded text-white text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a> details</div>

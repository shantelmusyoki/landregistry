					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
								...
								$state=$_REQUEST['id'];
								$query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid and city='$state'");
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img style="max-height:250px; min-height:250px;"src="admin/property/<?php echo $row['9'];?>" alt="pimage">
                                        
                                        <div class="sale bg-secondary text-white">For <?php echo $row['4'];?></div>
                                        <div class="price text-primary text-capitalize">KES <?php echo $row['6'];?> <span class="text-white"><?php echo $row['5'];?> Acres</span></div>

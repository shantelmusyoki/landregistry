            ...
            <div class="container">
                <div class="row">
					...
					<?php
						...
						$query=mysqli_query($con,"SELECT property.*, user.* FROM `property`,`user` WHERE property.uid=user.uid");
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-primary d-table px-3 py-2 rounded text-white text-capitalize">For <?php echo $row['4'];?></div>
                                <h5 class="mt-2 text-secondary text-capitalize"><?php echo $row['1'];?></h5>
                                <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-primary font-12"></i> &nbsp;<?php echo $row['7'];?></span>
							</div>
                            <div class="col-md-6">
                                <div class="text-primary text-left h5 my-2 text-md-right">KSHS <?php echo $row['6'];?>M</div>
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['1'];?></span> Title</li>
                                    <li><span class="text-secondary"><?php echo $row['5'];?></span> Size</li>
                                    <li><span class="text-secondary"><?php echo $row['6'];?></span> price</li>
                                    <li><span class="text-secondary"><?php echo $row['7'];?></span> Area</li>
                                    <li><span class="text-secondary"><?php echo $row['8'];?></span> County</li>
                                    <li><span class="text-secondary"><?php echo $row['4'];?></span> Type</li>
                                </ul>
                            </div>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">Contact seller</h5>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/<?php echo $row['9'];?>" alt="pimage">
                                    ...
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-primary icon-small"></i> <?php echo $row['7'];?></span>

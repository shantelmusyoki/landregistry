                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['10'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">KSH <?php echo $row['6'];?>M <span class="text-white"><?php echo $row['5'];?> hectares</span></div>
                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="period of payment (months)">
                            </div>
